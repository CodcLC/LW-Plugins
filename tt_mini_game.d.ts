...
declare const tt: {
    ...
    loadSubpackage(obj: { name: string, success?: Function, fail?: Function })
    ...
    createMoreGamesButton(obj: {
        type: string, style: MoreGameStyle,
        appLaunchOptions: Array<{ appId: string, query?: string, extraData?: object }>,
        image?: string, text?: string, onNavigateToMiniGame?: Function
    }): MoreGamesButton
    ...
    createGameClubButton(obj: {
        type: string, text: string, image: string,
        style: {
            left: number, top: number, width: number, height: number,
            backgroundColor?: string, borderColor?: string, borderWidth?: number,
            borderRadius?: number, textAlign?: string, fontSize?: number, lineHeight?: number
        }, icon: string
    }): any

    createUserInfoButton(obj: {
        type: string, text: string, image: string,
        style: any, withCredentials: boolean, lang: string
    }): UserInfoButton;
    /**
    ...
    shareAppMessage(object: {
        channel?: string, title?: string, imageUrl?: string, query?: string, desc?: string, templateId?: string, extra?: object,
        success?: (res: any) => void, fail?: (res: any) => void, complete?: (res: any) => void, cancel?: (res: any) => void
    }): void;
...
declare interface UserInfoButton {
    ...
    //监听用户点击事件
    onTap(cb: (res: {
        userInfo: UserInfo, rawData: string,
        signature: string, encryptedData: string, iv: string
    }) => void);
